...
class eZXMLInstallerHandlerManager
{
    ...
    function eZXMLInstallerHandlerManager()
    {
    ...
    function instance()
    {
        $instance =& $GLOBALS["eZXMLInstallerHandlerManagerInstance"];
        if ( get_class( $instance ) != "eZXMLInstallerHandlerManager" )
        {
            $instance = new eZXMLInstallerHandlerManager();
        }
        return $instance;
    }
    /*!
