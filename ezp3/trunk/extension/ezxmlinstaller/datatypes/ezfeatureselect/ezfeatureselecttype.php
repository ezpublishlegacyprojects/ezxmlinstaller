...
define( 'EZFEATURESELECTTYPE_DATA_TYPE_STRING', 'ezfeatureselect' );
define( 'EZFEATURESELECTTYPE_TEMPLATE_LOCATION_FIELD', "data_text1" );
define( 'EZFEATURESELECTTYPE_TEMPLATE_LOCATION_VARIABLE', "_ezfeatureselect_template_location_" );
...
class eZFeatureSelectType extends eZDataType
{
    ...
    */
    ...
    {
        $this->eZDataType( EZFEATURESELECTTYPE_DATA_TYPE_STRING, ezi18n( 'ezxmlinstaller/datatypes', 'Feature Select', 'Datatype name' ),
    ...
    */
    ...
    {
        $templateLocation = $base . EZFEATURESELECTTYPE_TEMPLATE_LOCATION_VARIABLE . $classAttribute->attribute( 'id' );
        if ( $http->hasPostVariable( $templateLocation ) )
        {
            $templateLocationValue = $http->postVariable( $templateLocation );

            $classAttribute->setAttribute( EZFEATURESELECTTYPE_TEMPLATE_LOCATION_FIELD, $templateLocationValue );
        }
        return true;
    }
    ...
    */
    function objectAttributeContent( $contentObjectAttribute )
    {
        ...
        $templateLocation = $classAttribute->attribute( EZFEATURESELECTTYPE_TEMPLATE_LOCATION_FIELD );
    ...
    */
    ...
    {
        $templateLocationString = $classAttribute->attribute( EZFEATURESELECTTYPE_TEMPLATE_LOCATION_FIELD );
    ...
    */
    ...
    {
        $templateLocation = $attributeParametersNode->elementTextContentByName( 'default-string' );
        $classAttribute->setAttribute( EZFEATURESELECTTYPE_TEMPLATE_LOCATION_FIELD, $templateLocation );
    }
...
eZDataType::register( EZFEATURESELECTTYPE_DATA_TYPE_STRING, 'eZFeatureSelectType' );
